...
\[
  ...
  \delta=6.29.
\]
The bootstrap median is $\alpha^*=28.83$ (95\% CI $[27.92,\,29.78]$). A
sparse grid concentrated within the subcritical plateau
($\mathrm{IoU}\equiv1.0$) cannot resolve $\alpha^*$ reliably, since a
bounded least-squares fit on plateau-only data is underdetermined; a
14-point grid extending to $\alpha=60$ (20 independent seeds, 1000-resample
bootstrap) is required to observe the full sigmoid S-curve and obtain the
estimate above.
...
Swish clusters with GELU and Mish in the smooth group in all $k\geq2$
clusterings (silhouette-verified).
